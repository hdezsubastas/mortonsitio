            ...
            <div class="fs-inner-container">
                <div class="fs-content">
                                    ...
                                    <div class="_mp_filter_first">
                                        <div class="filter_list_item">
                                            <div class="selected_item_wrap">
                                                <div class="slt_single_item"><router-link to="" class="remove_pills"><span class="pills_tex">2 Beds</span><span class="remove_cross"></span></router-link></div>
                                                <div class="slt_single_item"><router-link to="" class="remove_pills"><span class="pills_tex">2 Baths</span><span class="remove_cross"></span></router-link></div>
                                                <div class="slt_single_item"><router-link to="" class="remove_pills"><span class="pills_tex">Garage</span><span class="remove_cross"></span></router-link></div>
                                                <div class="slt_single_item"><router-link to="" class="remove_pills"><span class="pills_tex">2 More</span></router-link></div>
                                                <div class="slt_single_item"><router-link to="" class="clear_pills"><span class="pills_clears">Clear All</span></router-link></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="_mp_filter_last">
                                        <router-link to="" class="map_filter min" data-bs-toggle="modal" data-bs-target="#filter"><i class="fa fa-sliders-h mr-2"></i>Short Filter</router-link>
                                    </div>
                                </div>
                    ...
                    <div class="row justify-content-center list-layout g-4">
                        <div v-for="(item, index) in propertyData" :key="index" class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <ListLayoutTwo :item="item" :border="true"/>
                        </div>
                    </div>
