                            ...
                            <div class="hero-search-content">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <router-link to="#" class="btn btn-dark full-width">Search</router-link>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="gray-simple">
            <div class="container">
                        ...
                        <div class="item-shorting-box">
                            ...
                            <div class="item-shorting-box-right">
                                ...
                                <ul class="shorting-list">
                                    <li>
                                        <router-link to="/grid" class="w-12 h-12">
                                    ...
                                    <li>
                                        <router-link to="/list-layout-full" class="active w-12 h-12">
                ...
                <div class="row justify-content-center g-4">
                    <div v-for="(item, index) in propertyData" :key="index" class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                        <GridLayoutTwo :item="item"/>
                    </div>
                </div>
...
<script setup>
    ...
    import FilterModal from '@/components/property/filter-modal.vue';
    import GridLayoutTwo from '@/components/property/grid-layout-two.vue';
