                        ...
                        <div class="col col-sm-8">
                            <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#fff!important;">
								<ul class="navbar-nav  ms-auto flex-nowrap">
									<li class="nav-item nav-link active" href="#">Acerca</li>
									<li class="nav-item nav-link" href="#">¿Cómo Vender?</li>
									<li class="nav-item nav-link" href="#">Historia</li>
									<div class="btn-group">
										<button class="btn btn-secondary btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
											Idioma
										</button>
										<ul class="dropdown-menu">
											<li class="nav-item nav-link" href="#">Español</li>
											<li class="nav-item nav-link" href="#">English</li>
										</ul>
									</div>
								</ul>
							</nav>
				...
				<nav id="navigation"  :class="windowWidth > 991 ? 'navigation navigation-landscape' : 'navigation navigation-portrait'">
					...
					<div class="nav-menus-wrapper nav-menus-wrapper-open" :class="{ 'nav-menus-wrapper-open': toggle}" :style="{'left': toggle ? '0%' : '-100%'}">
						...
						<ul class="nav-menu">
							...
							<li :class="{active: ['/calendario','/departamentos'].includes(current),show: activeMenu['index-page'] && activeMenu['index-page']['main']}" @mouseenter="handleMouseEnter('auction-page')" @mouseleave="handleMouseLeave('auction-page')"><router-link to="" class="d-flex align-items-center">Subastas<span class="submenu-indicator"><span class="submenu-indicator-chevron"></span></span></router-link>
							...
							<li><router-link to="/" :class="current === '/calendario' ? 'active' : ''">Oficinas Regionales</router-link></li>
							<li><router-link to="/" :class="current === '/calendario' ? 'active' : ''">Contacto</router-link></li>
						...
						<ul class="nav-menu nav-menu-social align-to-right">
							<li class="add-listing">
								<router-link to="/submit-property"  style="background-color:#004d43!important;">
...
<script setup>
	...
	import logoMorton from '@/assets/img/logo-morton.jpg';
	import logoMiMorton from '@/assets/img/mimorton-logo.png';
