                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="footer-widget" style="text-align: center;">
                            <router-link class="nav-footer-logo" to="/">
                                <span class="svg-icon text-light svg-icon-2hx">
                                    <img :src="logoMorton" style="width:200px;">
                                </span>
                            </router-link>
                            <div class="footer-add">
                                <p>FAQS</p>
                                <p>Pluma y Martillo</p>
                                <p>Responsabilidad Social</p>
                                <p>Autos y Camiones</p>
                    ...
                    <!--<div class="col-lg-2 col-md-4">
                        <div class="footer-widget">
                            ...
                            <ul class="footer-menu">
                                ...
                                <li><router-link to="/faq">FAQs Page</router-link></li>
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="footer-widget">
                            ...
                            <ul class="footer-menu">
                                ...
                                <li><router-link to="#">My Houses</router-link></li>
                                <li><router-link to="#">Restaurant</router-link></li>
                                <li><router-link to="#">Nightlife</router-link></li>
                                <li><router-link to="#">Villas</router-link></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-6">
                        <div class="footer-widget">
                            ...
                            <ul class="footer-menu">
                                <li><router-link to="#">My Profile</router-link></li>
                                <li><router-link to="#">My account</router-link></li>
                                <li><router-link to="#">My Property</router-link></li>
                    ...
                    <!--div class="col-lg-3 col-md-6">
                        <div class="footer-widget">
                            ...
                            <router-link to="#" class="other-store-link">
                            ...
                            <router-link to="#" class="other-store-link">
                                <div class="other-store-app">
                                    ...
                                    <div class="os-app-caps">App Store<span>Now it Available</span></div>
                                </div>
                            </router-link>
                        </div>
                    </div>-->
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <p class="mb-0">© {{year}} Morton Subastas<i class="fa-solid fa-heart ms-1 text-danger"></i>  By <a href="https://shreethemes.in/" target="_blank">Morton Subastas</a></p>
                    </div>
                    <div class="col-lg-6 col-md-6 text-right">
                        <ul class="footer-bottom-social">
                        <li><a href="https://www.facebook.com/mortonsubastas" target='_blank'><i class="fa-brands fa-facebook"></i></a></li>
                        <li><a href="https://x.com/mortonsubastas" target='_blank'><i class="fa-brands fa-twitter"></i></a></li>
                        <li><a href="https://www.instagram.com/mortonsubastas/" target='_blank'><i class="fa-brands fa-instagram"></i></a></li>
                        <li><a href="https://www.tiktok.com/@mortonsubastas" target='_blank'><i class="fa-brands fa-linkedin"></i></a></li>
                    </ul>
                    </div>
                </div>
            </div>
...
<script setup>
    import { ref } from 'vue';
    import logoMorton from '@/assets/img/morton-caballo.png';
